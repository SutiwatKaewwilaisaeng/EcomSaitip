...
import com.example.ecomsaitip.Seller.SellerHomeActivity;
import com.example.ecomsaitip.Seller.SellerRegistrationActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UserPhoneKey != "" && UserPasswordKey != ""){
            if (!TextUtils.isEmpty(UserPhoneKey) && !TextUtils.isEmpty(UserPasswordKey)){
                ...
                loadingbar.setTitle("Already Log in");
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("Users").child(phone).exists()){
                    ...
                    loadingbar.dismiss();
                    Toast.makeText(MainActivity.this,"Account with this"+phone+"Number do not exitst",Toast.LENGTH_SHORT).show();
