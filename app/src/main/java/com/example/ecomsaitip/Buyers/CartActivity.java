...
import com.example.ecomsaitip.Model.Cart;
import com.example.ecomsaitip.Prevalent.Prevalent;
import com.example.ecomsaitip.R;
import com.example.ecomsaitip.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg.setText("Congratulations, your final shipped has been placed successfully. Soon you will received your order at your door step.");
                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this,"you can purchase more products, once you received your first final",Toast.LENGTH_SHORT).show();
